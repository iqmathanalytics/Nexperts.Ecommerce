        ...
        !function(n2) {
          ...
          var i2 = "function", a2 = "undefined", o = "object", s = "string", l = "major", u = "model", c = "name", d = "type", h = "vendor", p = "version", f = "architecture", g = "console", v = "mobile", m = "tablet", b = "smarttv", _ = "wearable", y = "embedded", w = "Amazon", E = "Apple", x = "ASUS", C = "BlackBerry", R = "Browser", O = "Chrome", S = "Firefox", T = "Google", P = "Huawei", N = "Microsoft", A = "Motorola", k = "Opera", I = "Samsung", M = "Sharp", j = "Sony", D = "Xiaomi", L = "Zebra", $ = "Facebook", U = "Chromium OS", q = "Mac OS", B = function(e2, t3) {
            ...
            return this.getBrowser = function() {
              ...
              var e3 = {};
              return e3[c] = void 0, e3[p] = void 0, X.call(e3, g2, _2.os), y2 && !e3[c] && b2 && "Unknown" != b2.platform && (e3[c] = b2.platform.replace(/chrome os/i, U).replace(/macos/i, q)), e3;
  ...
  `), Object.defineProperty(this, "__NEXT_ERROR_CODE", { value: "E1177", enumerable: false, configurable: true });
      ...
      class U {
        ...
        formatPathname() {
          ...
          }((e10 = { basePath: this[$].basePath, buildId: this[$].buildId, defaultLocale: this[$].options.forceLocale ? void 0 : this[$].defaultLocale, locale: this[$].locale, pathname: this[$].url.pathname, trailingSlash: this[$].trailingSlash }).pathname, e10.locale, e10.buildId ? void 0 : e10.defaultLocale, e10.ignorePrefix), (e10.buildId || !e10.trailingSlash) && (t10 = P(t10)), e10.buildId && (t10 = k(A(t10, `/_next/data/${e10.buildId}`), "/" === e10.pathname ? "index.json" : ".json")), t10 = A(t10, e10.basePath), !e10.buildId && e10.trailingSlash ? t10.endsWith("/") ? t10 : k(t10, "/") : P(t10);
        }
        formatSearch() {
      ...
      class ei extends Request {
        constructor(e10, t10 = {}) {
          ...
          const n2 = new U(r2, { headers: E(this.headers), nextConfig: t10.nextConfig });
      ...
      class eu extends Response {
        constructor(e10, t10 = {}) {
          ...
          this[eo] = { cookies: n2, url: t10.url ? new U(t10.url, { headers: E(r2), nextConfig: t10.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
      ...
      async function tS(t10) {
        ...
        if ((s2 = await tR(w2, () => {
          if ("/middleware" === t10.page || "/src/middleware" === t10.page || "/proxy" === t10.page || "/src/proxy" === t10.page) {
            ...
            return e4().trace(eU.execute, { spanName: `middleware ${w2.method}`, attributes: { "http.target": w2.nextUrl.pathname, "http.method": w2.method } }, async () => {
              try {
                var n3, i3, a3, o3, s3;
      ...
      let t$ = tD("\x1B[31m", "\x1B[39m"), tU = tD("\x1B[32m", "\x1B[39m"), tq = tD("\x1B[33m", "\x1B[39m");
      tD("\x1B[34m", "\x1B[39m");
      let tB = tD("\x1B[35m", "\x1B[39m");
      tD("\x1B[38;2;173;127;168m", "\x1B[39m"), tD("\x1B[36m", "\x1B[39m");
      let tH = tD("\x1B[37m", "\x1B[39m");
      tD("\x1B[90m", "\x1B[39m"), tD("\x1B[40m", "\x1B[49m"), tD("\x1B[41m", "\x1B[49m"), tD("\x1B[42m", "\x1B[49m"), tD("\x1B[43m", "\x1B[49m"), tD("\x1B[44m", "\x1B[49m"), tD("\x1B[45m", "\x1B[49m"), tD("\x1B[46m", "\x1B[49m"), tD("\x1B[47m", "\x1B[49m"), tH(tL("\u25CB")), t$(tL("\u2A2F")), tq(tL("\u26A0")), tH(tL(" ")), tU(tL("\u2713")), tB(tL("\xBB")), new tA(1e4, (e10) => e10.length), new tA(1e4, (e10) => e10.length);
      ...
      e.s(["config", 0, { matcher: ["/((?!_next/static|_next/image|_next/webpack-hmr|favicon.ico|api/|.*\\.(?:svg|png|jpg|jpeg|gif|webp|avif|ico|woff2?)$).*)"] }, "middleware", 0, function(e10) {
        ...
        if ((t10.startsWith("/account") || t10.startsWith("/checkout") && "/checkout/success" !== t10) && !e10.cookies.get("customer_session")?.value) {
          let r3 = new URL("/login", e10.url);
          return r3.searchParams.set("next", t10), eu.redirect(r3);
        }
        let r2 = new Headers(e10.headers);
        return r2.set("x-pathname", t10), eu.next({ request: { headers: r2 } });
      }], 96592);
...
var require_turbopack_node_modules_next_dist_esm_build_templates_edge_wrapper_0a9xbl8 = __commonJS({
  ".next/server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0a9xbl8.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0a9xbl8.js", { otherChunks: ["chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_0_kjzx3.js", "chunks/[root-of-the-server]__0emy-m4._.js"], runtimeModuleIds: [35825] }]), (() => {
      ...
      O.prototype = URL.prototype, l.U = O, l.z = function(e2) {
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|_next\\/webpack-hmr|favicon.ico|api\\/|.*\\.(?:svg|png|jpg|jpeg|gif|webp|avif|ico|woff2?)$).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
