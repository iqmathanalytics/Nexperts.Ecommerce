...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `), Object.defineProperty(this, "__NEXT_ERROR_CODE", { value: "E1177", enumerable: false, configurable: true });
      ...
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_slot_(\\d+)__[\\n\\s]"), ew(), e.s(["config", 0, { matcher: ["/admin/:path*", "/account/:path*", "/cart", "/checkout", "/checkout/:path*"] }, "middleware", 0, function(e10) {
        let { pathname: t10 } = e10.nextUrl;
        if (t10.startsWith("/admin") && "/admin/login" !== t10 && !e10.cookies.get("admin_token")?.value) return eu.redirect(new URL("/admin/login", e10.url));
        if ((t10.startsWith("/account") || "/cart" === t10 || t10.startsWith("/checkout")) && !e10.cookies.get("customer_token")?.value) {
