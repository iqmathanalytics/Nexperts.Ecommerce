...
export const DEFAULT_EDITORIAL: StorefrontEditorial = {
  ...
  dressEdits: [
    { href: "/category/evening-dresses?gender=WOMEN", label: "Evening", title: "After dark", image: px(31132239, 900) },
    { href: "/category/maxi-dresses?gender=WOMEN", label: "Maxi", title: "Long line", image: u("photo-1539008835657-9e8e9680c956", 900) },
    { href: "/category/casual-dresses?gender=WOMEN", label: "Day", title: "Everyday silk", image: u("photo-1572804013309-59a88b7e92f1", 900) },
  ],
